  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-1 text-sm text-neutral-500">Create and manage client proposals and quotes.</p>
      </div>

      <div className="flex items-center justify-center h-64 rounded-xl border-2 border-dashed border-neutral-200 bg-white">
        <div className="text-center">
          <FileSignature size={40} className="mx-auto mb-3 text-neutral-300" />
